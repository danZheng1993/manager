...
import { GET_JOB, GET_JOBS, CREATE_JOB, UPDATE_JOB, 
  DELETE_JOB, APPLY_JOB, SEARCH_JOB, HIRE_JOB, UPDATE_JOB_STATUS }
  from '../modules/job'
...
const doUpdateJobStatus = apiCall({
  type: UPDATE_JOB_STATUS,
  method: 'put',
  path: ({ payload }) => `/jobs/updateStatus/${payload.id}/`
})
...
export default function* rootSaga () {
  ...
  yield takeLatest(UPDATE_JOB_STATUS, doUpdateJobStatus)
